...
// 11.
// In cludes method use panna output => that world irutha true or fales
// function checkString(){

//     const inpEl = document.getElementById("in1").value;

//     const vale = inpEl.includes('Java');

//     document.getElementById("result").innerHTML = vale ;
// }
// checkString();
...
//     const inp1EL = document.getElementById("in1").value ;
//     const inp2EL = document.getElementById("in2").value ;
//     if( Number(inp1EL) < Number(inp2EL)){
